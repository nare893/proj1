  ...
  <header class="header" data-header>
    ...
    <div class="header-top">
      <div class="container">
        ...
        <a href="tel:+91 7338143119" class="helpline-box">
          ...
          <div class="wrapper">
            ...
            <p class="helpline-number">+91 (93800) 4567 </p>
          </div>
          ...
          <ul class="popular-list">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/popular-1.jpg?raw=true" alt="San miguel, italy" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/popular-2.jpg?raw=true" alt="Burj khalifa, dubai" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/popular-3.jpg?raw=true" alt="Kyoto temple, japan" loading="lazy">
                </figure>
          ...
          <ul class="package-list">
            ...
            <li>
              <div class="package-card">
                ...
                <figure class="card-banner">
                  <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/packege-1.jpg?raw=true" alt="Experience The Great Holiday On Beach" loading="lazy">
                </figure>
            ...
            <li>
              <div class="package-card">
                ...
                <figure class="card-banner">
                  <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/packege-2.jpg?raw=true" alt="Summer Holiday To The Oxolotan River" loading="lazy">
                </figure>
            ...
            <li>
              <div class="package-card">
                ...
                <figure class="card-banner">
                  <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/packege-3.jpg?raw=true" alt="Santorini Island's Weekend Vacation" loading="lazy">
                </figure>
          ...
          <ul class="gallery-list">
            ...
            <li class="gallery-item">
              <figure class="gallery-image">
                <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/gallery-1.jpg?raw=true" alt="Gallery image">
              </figure>
            </li>

            <li class="gallery-item">
              <figure class="gallery-image">
                <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/gallery-2.jpg?raw=true" alt="Gallery image">
              </figure>
            </li>

            <li class="gallery-item">
              <figure class="gallery-image">
                <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/gallery-3.jpg?raw=true" alt="Gallery image">
              </figure>
            </li>

            <li class="gallery-item">
              <figure class="gallery-image">
                <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/gallery-4.jpg?raw=true" alt="Gallery image">
              </figure>
            </li>

            <li class="gallery-item">
              <figure class="gallery-image">
                <img src="https://github.com/codewithsadee/tourly/blob/master/assets/images/gallery-5.jpg?raw=true" alt="Gallery image">
              </figure>
            </li>
        ...
        <div class="footer-contact">
          ...
          <ul>
            ...
            <li class="contact-item">
              ...
              <a href="tel:+91123456790" class="contact-link">+91 (73381) (43119)</a>
            </li>
            ...
            <li class="contact-item">
              ...
              <address>1432 Bangalore, India</address>
            </li>
